...
func bindPairV2(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(PairV2ABI))
	if err != nil {
		return nil, err
	}
...
func (_PairV2 *PairV2Caller) DOMAINSEPARATOR(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _PairV2.contract.Call(opts, &out, "DOMAIN_SEPARATOR")
...
//
// Solidity: function DOMAIN_SEPARATOR() view returns(bytes32)
func (_PairV2 *PairV2Session) DOMAINSEPARATOR() ([32]byte, error) {
	return _PairV2.Contract.DOMAINSEPARATOR(&_PairV2.CallOpts)
}

// DOMAINSEPARATOR is a free data retrieval call binding the contract method 0x3644e515.
//
// Solidity: function DOMAIN_SEPARATOR() view returns(bytes32)
func (_PairV2 *PairV2CallerSession) DOMAINSEPARATOR() ([32]byte, error) {
	return _PairV2.Contract.DOMAINSEPARATOR(&_PairV2.CallOpts)
}
...
func (_PairV2 *PairV2Caller) PERMITTYPEHASH(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _PairV2.contract.Call(opts, &out, "PERMIT_TYPEHASH")
...
//
// Solidity: function PERMIT_TYPEHASH() view returns(bytes32)
func (_PairV2 *PairV2Session) PERMITTYPEHASH() ([32]byte, error) {
	return _PairV2.Contract.PERMITTYPEHASH(&_PairV2.CallOpts)
}

// PERMITTYPEHASH is a free data retrieval call binding the contract method 0x30adf81f.
//
// Solidity: function PERMIT_TYPEHASH() view returns(bytes32)
func (_PairV2 *PairV2CallerSession) PERMITTYPEHASH() ([32]byte, error) {
	return _PairV2.Contract.PERMITTYPEHASH(&_PairV2.CallOpts)
}
...
func (_PairV2 *PairV2Caller) Nonces(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _PairV2.contract.Call(opts, &out, "nonces", arg0)
...
//
// Solidity: function nonces(address ) view returns(uint256)
func (_PairV2 *PairV2Session) Nonces(arg0 common.Address) (*big.Int, error) {
	return _PairV2.Contract.Nonces(&_PairV2.CallOpts, arg0)
}

// Nonces is a free data retrieval call binding the contract method 0x7ecebe00.
//
// Solidity: function nonces(address ) view returns(uint256)
func (_PairV2 *PairV2CallerSession) Nonces(arg0 common.Address) (*big.Int, error) {
	return _PairV2.Contract.Nonces(&_PairV2.CallOpts, arg0)
}
...
func (_PairV2 *PairV2Transactor) Permit(opts *bind.TransactOpts, owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _PairV2.contract.Transact(opts, "permit", owner, spender, value, deadline, v, r, s)
}

// Permit is a paid mutator transaction binding the contract method 0xd505accf.
//
// Solidity: function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) returns()
func (_PairV2 *PairV2Session) Permit(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _PairV2.Contract.Permit(&_PairV2.TransactOpts, owner, spender, value, deadline, v, r, s)
}

// Permit is a paid mutator transaction binding the contract method 0xd505accf.
//
// Solidity: function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) returns()
func (_PairV2 *PairV2TransactorSession) Permit(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _PairV2.Contract.Permit(&_PairV2.TransactOpts, owner, spender, value, deadline, v, r, s)
}
